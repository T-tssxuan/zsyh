# Author: Luo Xuan
# This file is the traditional regression algorithm based on the gbrt algrithm
# Dependency: numpy, scikit-learn, pandas
# Run: python3 gbrt.py
...
# The predicton function to predict the result
